...
*include macros;
%include 'C:\Users\fdimaspr\Desktop\UNCPP1\Scripts\macros.sas';

*I define my local permanent library and my local library for raw data;
libname rawcomp 'F:\Academic\RAW DATABASES\RCopustat_2015';
libname rawdscan  'F:\Academic\RAW DATABASES\RDealScan_2015';
libname rawibes  'F:\Academic\RAW DATABASES\RIbes_2015';

libname raw 'C:\Users\fdimaspr\Desktop\projectrawdata';
libname fig 'C:\Users\fdimaspr\Desktop\UNCPP1Writing\figures';
libname dimmod 'C:\Users\fdimaspr\Desktop\UNCPP1\modified' ;
...
proc sql ;
       ...
       from rawibes.idsum
       where (year(SDATES) eq 2014) & (USFIRM eq 1);
quit;



proc export data=work.tickers outfile='C:\Users\fdimaspr\Desktop\fdimasprsumemrpaper\uncsummerpaper\tickers.txt' dbms=tab replace;                                              
putnames=no;
run;
...
libname mine '/home/unc/fdimaspr'; *define a home directory on WRDS;
